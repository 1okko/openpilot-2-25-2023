...
const QColor bg_colors [] = {
  [STATUS_DISENGAGED] =  QColor(0xFF, 0xFF, 0xFF, 0xf1),
  [STATUS_OVERRIDE] = QColor(0x5D, 0x0, 0xAF, 0xf1),
  [STATUS_ENGAGED] = QColor(0x0, 0xFF, 0x0, 0xf1),
  [STATUS_MADS] = QColor(0x0, 0x93, 0x0, 0xf1),
  [STATUS_WARNING] = QColor(0xE, 0x17, 0x1F, 0xf1),
  [STATUS_ALERT] = QColor(0x5D, 0x0, 0xAF, 0xf1),
};
